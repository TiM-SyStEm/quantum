...
{
    [Plug(Target = typeof(Sys.Console))]
    public static class ConsoleImpl
    {
        ...
        private static Quantum.Drawing.Console GetConsole()
        {
            return Quantum.Kernel.AConsole;
        }
        ...
        {
            var xConsole = GetConsole();
            if (xConsole.Type == Drawing.ConsoleType.Text)
            {
        ...
        public static void Write(string aText)
        {
            ...
            xConsole.Write(aText.ToCharArray());
        }
